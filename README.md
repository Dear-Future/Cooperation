...
6、技术能力，包括但不限于在企业级软件应用、企业级解决方案定制、企业级应用推广运营、企业级微服务（K8S）、战略规划、编程技术（包括但不限于C/C++、Java、Python等等）、互联网技术、数据库、系统架构、算法、信息安全、数据安全、硬件安全、操作系统安全、网络安全、攻防对抗、协议分析、逆向分析（包括但不限于IDA、OllyDbg、WinDbg、C32ASM、WinHex等等）、人才培养等多个领域有深入研究、理解及实战经验；
