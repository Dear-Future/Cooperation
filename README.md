...
5、行业能力，在信息化管理、IT技术、工业智能化、安全领域、人才发掘与培养等领域，有实战和深耕经验；
6、技术能力，包括但不限于在企业级软件应用、企业级解决方案定制、企业级应用推广运营、编程技术、互联网技术、数据库、系统架构、信息安全、攻防对抗、协议分析、逆向分析、人才培养等多个领域有深入研究、理解及实战经验；
