...
4、高水准过硬的综合素质，非那些工程师可相提并论，产生的价值具有四两拨千斤的重要意义，能解决的问题,带来的收益，远比阁下能想到的要多得多;
...
8、支持领域包括但不限于计算机软硬件、安全研究与应用、信息化、数字化、物联网（含工业互联网）、智能制造、机器视觉、机器学习、神经网络、大数据应用、系统集成、数据分析、领域创新、人才培养、企业级应用实战、解决方案定制、综合管理等等；
